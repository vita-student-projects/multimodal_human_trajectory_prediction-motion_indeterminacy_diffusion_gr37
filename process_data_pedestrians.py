...
data_folder_name = 'drive/MyDrive/DLAV-2023/MID/processed_data_noise'
...
for desired_source in ['eth', 'hotel', 'univ', 'zara1', 'zara2']:
    for data_class in ['train', 'val', 'test']:
        ...
        for subdir, dirs, files in os.walk(os.path.join('drive/MyDrive/DLAV-2023/MID/raw_data', desired_source, data_class)):
            for file in files:
